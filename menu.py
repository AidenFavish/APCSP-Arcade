...
class Menu(helper.Page):
    def __init__(self, app):
        ...
        self.cribbage_button = helper.ClassicButton(app.buttons, 500, 250, 200, 75, "CRIBBAGE", lambda: app.change_page("CRIBBAGE_MENU"), arcade.color.FOREST_GREEN)
